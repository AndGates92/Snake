...
namespace graphics_utils {
	...
	int win_node_add(std::string window_title, std::string window_type, int window_width, int window_height, int window_x_pos, int window_y_pos, void (*WrapperFunc)(), colours::palette_e background_colour);
