...
namespace window_list {
	...
	class WindowList : public basic_obj_list::BasicObjList<window_node::WindowNode> {
		public:
			...
			int add_node(std::string window_title, std::string window_type, int window_width, int window_height, int window_x_pos, int window_y_pos , void (*EntryFunc)(int), void (*ItemsFunc)(), void (*WrapperFunc)(), colours::palette_e background_colour);
