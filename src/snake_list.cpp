...
void snake_list::SnakeList::add_node(int centre_x, int centre_y, snake_node::direction_e snake_direction, graphics_utils::palette_e snake_colour) {

	LOG_INFO(log::verb_level_e::LOW, "[Add Node] Centre coordinares: (X ", centre_x, ", Y ", centre_y, "), direction ", snake_direction, " colour ", snake_colour, ".");
	snake_node::SnakeNode * new_snake = new snake_node::SnakeNode(centre_x, centre_y, snake_direction, snake_colour);
