...
int window_list::WindowList::add_node(std::string window_title, std::string window_type, int window_width, int window_height, int window_x_pos, int window_y_pos , void (*EntryFunc)(int), void (*ItemsFunc)(), void (*WrapperFunc)(), colours::palette_e background_colour) {
	...
	window_node::WindowNode * new_window = new window_node::WindowNode(window_title, window_type, window_width, window_height, window_x_pos, window_y_pos, EntryFunc, ItemsFunc, WrapperFunc, background_colour);
